...
export const cocoa = {
  ...
  async promise<T>(
    ...
    const id = store.addToast(
      { ...opts.loading, position, duration: null },
      'loading'
    );
    ...
    try {
      ...
      if (opts.action) {
        ...
        store.addToast({ ...actionOpts, id, position }, 'default');
      } else {
        const successOpts =
          typeof opts.success === 'function'
            ? opts.success(data)
            : opts.success;
        store.addToast({ ...successOpts, id, position }, 'success');
      }
      ...
      store.addToast({ ...errorOpts, id, position }, 'error');
      throw err;
    }
  },
